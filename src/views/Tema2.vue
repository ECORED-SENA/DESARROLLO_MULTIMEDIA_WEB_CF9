...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-5.mb-4
        img.img-t(src='@/assets/curso/tema2/img01.svg', alt='') 
    ...
    .bg_fondo2-t2.mb-5.p-4
      ...
      .row.align-items-center
        .col-lg-4
          figure(data-aos="fade-right")
            img.img-t(src='@/assets/curso/tema2/img20.svg')
        .col-lg-8
          .bg_slyder1.p-5
              ...
              .p-4
                SlyderE(indicadores="derecha").color_slyder-a_botones
                  .row.justify-content-center
                    .col-lg-10                  
                      figure.mb-4
                        img.img-t(src='@/assets/curso/tema2/img30.svg', alt='AvatarTop') 
        ...
        .col-lg-10
          .bloque-texto-a.color-secundario.p-md-5
            .row.m-0.align-items-center.justify-content-between
              ...
              .col-lg-4
                img(src='@/assets/curso/tema2/img35.svg' alt='AvatarTop') 
