  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-5(data-aos="fade-left")
        figure
          img.img-t.mx-auto(src='@/assets/curso/tema3/img01.svg', alt='')
        ...
        .col-lg-12
          .bg_fondo2-t3
            .row.justify-content-center.align-items-center
              ...
              .col-lg-8.mt-4(data-aos="fade-right")
                .bg_slyder-t3.mb-4
                  .p-3.p-lg-5 
                    SlyderE(indicadores="derecha").color_slyder-a_botones.m_sly-action
                      ...
                      .row.justify-content-center
                        .col-10.col-md-11.col-lg-12
                          ...
                          figure
                            img.img-t.mx-auto(src='@/assets/curso/tema3/img05.png', alt='AvatarTop')
